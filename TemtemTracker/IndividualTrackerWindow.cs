...
namespace TemtemTracker
{
    public partial class IndividualTrackerWindow : Form
    {
        ...
        private void IndividualTrackerWindow_Shown(object sender, EventArgs e)
        {
            ...
            System.Drawing.Size textRow1 = TextRenderer.MeasureText("Aguja%", label2.Font);
            System.Drawing.Size textRow2 = TextRenderer.MeasureText("Aguja%", label4.Font);

            TLP_2.RowStyles[0] = new RowStyle(SizeType.Absolute, (float)Math.Round((textRow1.Height * 1.35)));
            TLP_3.RowStyles[0] = new RowStyle(SizeType.Absolute, (float)Math.Round((textRow2.Height * 1.35)));
        }
    }
}
